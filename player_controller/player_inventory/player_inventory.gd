...
onready var inventory_card = preload("res://player_controller/player_inventory/inventory_card.tscn")
onready var base_seed = preload("res://plant_seeds/base_seed.tscn")
onready var base_plant = preload("res://harvested_plants/base_plant.tscn")
